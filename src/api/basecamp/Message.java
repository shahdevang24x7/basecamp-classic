...
public class Message extends BaseCampEntity {
	...
	/***
	 * Create new (UNSAVED) BaseCamp message, set appropriate fields and use
	 * '.save()' to post the message
	 * 
	 * @param auth
	 *            BCAuth Object
	 */
	...
	/***
	 * 
	 * If project has not been saved to basecamp yet (id == 0) then we will set the
	 * proper projectId to associate this message with upon saving.
	 * 
	 * @param projectId
	 *            ID of project you wish to associate this message.
	 */
