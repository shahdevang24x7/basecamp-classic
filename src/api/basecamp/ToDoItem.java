...
public class ToDoItem extends BaseCampEntity {
	...
	/***
	 * Create new (UNSAVED) BaseCamp ToDo Item, set appropriate fields and use
	 * '.save()' to post the item
	 * 
	 * @param auth
	 *            BCAuth Object
	 */
	 ...
	 * 
	 * @param toDoListId
	 *            ID of ToDoList you wish to associate this message.
	 */
